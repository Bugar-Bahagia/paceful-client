  ...
  return (
    <div className="flex justify-center p-4">
      <div ref={formRef} className="w-full max-w-md p-4 bg-white rounded-md shadow-md px-12">
        <h2 className="text-black text-lg font-semibold mb-2 text-center">Gemini AI Work Out Instructions</h2>

        <input type="text" placeholder="Enter work out genre (e.g., run, swim)" value={genre} onChange={(e) => setGenre(e.target.value)} className="w-full p-2 border border-gray-300 rounded mb-2" />
        <button onClick={handleSend} className="w-full p-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition mb-4">
